...
const Register = () => {
    ...
    return (
        <div className="container mx-auto px-10rem"> {/* Use container class with padding */}
            <form className="flex flex-col gap-5" onSubmit={onSubmit}>
                ...
                <span>
                    <button type="submit" className="bg-green-600 text-white p-2 font-bold hover:bg-blue-500 text-xl">Create Account</button>
                </span>
            </form>
        </div>
    );
